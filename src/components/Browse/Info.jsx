...
const Info = ()=>{
    ...
    return (
        ...
        <div style={{display:"flex",flexDirection:"column",gap:"12px",position:"relative", top:"2vw"}}>
            <p style={{color:'white',fontSize:"150%"}}>{info.Name}</p>
            <p style={{color:'white',fontSize:"150%"}}>{info.Email}</p>
            <p style={{color:'white',fontSize:"200%"}}>{info.Username}</p>
