...
const Timer = ()=>{
  ...
  return `${hours}:${minutes}:${seconds}`;
    ...
    return (
        <div style={{width:"62.5vw",height:"30vh",background:"#1E2343",position:"absolute", borderRadius:"12px",marginTop:"6px",display:"flex", gap:"20px",boxSizing:"border-box",padding:"12px", alignItems:"center", justifyContent:"space-evenly"}}>
            <div>
