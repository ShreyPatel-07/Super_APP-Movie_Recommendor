...
const genres = [
    {
        id:"Action",
        color:"#FF5209",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={action}/>
    },
    {
        id:"Drama",
        color:"#D7A4FF",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={drama}/>
    },{
        id:"Fantasy",
        color:" #FF4ADE",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={fantasy}/>
    },
    {
        id:"Fiction",
        color:"#6CD061",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={fiction}/>
    },
    {
        id:"Horror",
        color:"#7358FF",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={horror}/>
    },
    {
        id:"Music",
        color:"#E61E32",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={music}/>
    },{
        id:"Romance",
        color:"#11B800",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={romance}/>
    },{
        id:"Thriller",
        color:"#84C2FF",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={thriller}/>
    },{
        id:"Western",
        color:"#912500",
        image:<img style={{width:"160px", height:"120px", position:"relative", top: "10%"}}  src={western}/>
    }
]
const Category = ()=>{
...
const Block = ({data,idx, setCategories, categories})=>{
    ...
    return (
        <div data={data}  onClick={(e)=>handleClick(e)}  key={idx} style={{background:data['color'],color:"white",padding:"16px",borderRadius:"12px",border:`${selected?"4px solid green":"4px solid white"}`}}>
            <p style={{marginBottom:"4px",fontSize:"25px"}}>{data.id}</p>
            {data.image}
        </div>
    )
}
